...
<div class="span-24">
    ...
    <div class="span-16 clear" style="margin-top:5em"><p class="notice">To make an add priority place a 1 in the field, to remove priority change the value to 0.</p></div>
  ...
  <?php if(count($frontads)) : foreach ($frontads->result() as $row): ?>
    ...
    <tr>
      ...
      <?=form_open('ads/setpriority'); ?>
      <input type="hidden" name="id" value="<?=$row->id; ?>" /> 
      <td width="40px"><p><input type="text" value="<?=$row->priority;?>" name="priority"></p></td>
      <td width="10px">
